  ...
  <section class="w-full flex flex-col">
    <div class="container">
      ...
      <div class="grid grid-cols-1 2xl:grid-cols-5 xl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-2 gap-5">
        <AppInput  type="search" :modelValue="searchQuery" @input="searchByName" placeholder="Filter by name..." />
        <AppSelect :options="speciesOptions" label="Species" v-model="selectedSpecies" />
        <AppSelect :options="genderOptions" label="Gender" v-model="selectedGender" />
        <AppSelect :options="statusOptions" label="Status" v-model="selectedStatus" />
